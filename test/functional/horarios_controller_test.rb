...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { aula: @horario.aula, curso_id: @horario.curso_id, dia: @horario.dia, hora: @horario.hora, instructor: @horario.instructor, materia_id: @horario.materia_id }
    end
  ...
  test "should update horario" do
    put :update, id: @horario, horario: { aula: @horario.aula, curso_id: @horario.curso_id, dia: @horario.dia, hora: @horario.hora, instructor: @horario.instructor, materia_id: @horario.materia_id }
    assert_redirected_to horario_path(assigns(:horario))
  end
